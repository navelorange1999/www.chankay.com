...
export interface ImageMediaBaseProps {
	alt?: string
	className?: string
	...
	resource?: MediaInterface | string | null
	size?: string
...
export function ImageMediaBase(props: ImageMediaBaseProps) {
	const {
		alt: altFromProps,
		className,
		fill,
	...
	if (!src && resource && typeof resource === "object") {
		const { alt: altFromResource, height: fullHeight, thumbnailURL, width: fullWidth } = resource
	...
	return (
		<picture className={cn(className, pictureClassName)} onClick={onClick}>
			<NextImage
				alt={alt || ""}
