...
describe("Translation Detector", () => {
	describe("isLocalizedFieldValue", () => {
		...
		it("should handle null and undefined", () => {
			expect(isLocalizedFieldValue({} as Record<string, unknown>)).toBe(false)
		})
	})
	...
	describe("detectLocalizedFields", () => {
		...
		it("should detect nested localized fields", () => {
			...
			expect(fields.find((f) => f.path === "seo.description")).toBeDefined()
		})
	...
	describe("pathUtils", () => {
		...
		it("should get nested values correctly", () => {
			...
			expect(pathUtils.getValue(testData, "seo.title.zh-CN")).toBe("SEO标题")
		...
		it("should create nested paths when setting", () => {
			...
			expect(pathUtils.getValue(data, "deeply.nested.path")).toBe("value")
		})
	...
	describe("hasMissingTranslations", () => {
		it("should detect missing translations", () => {
			...
			expect(hasMissingTranslations(data, ["title", "excerpt"], "en")).toBe(true)
		...
		it("should handle non-existent fields", () => {
			...
			expect(hasMissingTranslations(data, ["nonexistent"], "en")).toBe(true)
		})
	})
})
